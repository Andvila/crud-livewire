                ...
                <form wire:submit.prevent="update">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <span class="text-danger">
                            @error('upd_continent') {{ $message }}   @enderror
                        </span>
                    </div>
                    <div class="form-group mb-3">
                        <label class="form-label" for="">Nombre del pais</label>
                        <input type="text" class="form-control" placeholder="Nombre del pais" wire:model="upd_country_name">
                        <span class="text-danger">
                            @error('upd_country_name') {{ $message }}   @enderror
                        </span>
                    </div>
                    <div class="form-group mb-3">
                        <label class="form-label" for="">Ciudad Capital</label>
                        <input type="text" class="form-control" placeholder="Ciudad Capital" wire:model="upd_capital_city">
                        <span class="text-danger">
                            @error('upd_capital_city') {{ $message }}   @enderror
                        </span>
                    </div>
                    <div class="form-group mb-3">
